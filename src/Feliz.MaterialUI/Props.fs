...
type accordion =
  ...
  static member inline sx (styleOverrides: IStyleAttribute list) = Interop.mkAttr "sx" styleOverrides
  ///   The system prop that allows defining system overrides as well as additional CSS styles. See the [`sx` page](https://mui.com/system/the-sx-prop/) for more details.
  static member inline sx (enabled: bool list) = Interop.mkAttr "sx" enabled
  ///   The system prop that allows defining system overrides as well as additional CSS styles. See the [`sx` page](https://mui.com/system/the-sx-prop/) for more details.
  static member inline sx (themeOverride: Theme -> IStyleAttribute list) = Interop.mkAttr "sx" themeOverride
  ///   The system prop that allows defining system overrides as well as additional CSS styles. See the [`sx` page](https://mui.com/system/the-sx-prop/) for more details.
  static member inline sx (themeOverrides: (Theme -> IStyleAttribute list) list) = Interop.mkAttr "sx" themeOverrides
...
type buttonUnstyled =
  ///   A ref for imperative actions. It currently only supports `focusVisible()` action.
  static member inline action (ref: IRefValue<ButtonUnstyledActions option>) = Interop.mkAttr "action" ref
  ///   A ref for imperative actions. It currently only supports `focusVisible()` action.
  static member inline action (handler: ButtonUnstyledActions -> unit) = Interop.mkAttr "action" handler
